...
class CoolproxySpider(scrapy.Spider):
    ...
    start_urls = ['https://www.cool-proxy.net/proxies/http_proxy_list/sort:score/direction:desc/']
    custom_settings = {
        'ITEM_PIPELINES': {
    ...
    def __genarateUrl(self, page):
        return 'https://www.cool-proxy.net/proxies/http_proxy_list/page:{0}/sort:score/direction:desc'.format(page)
